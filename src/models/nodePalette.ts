...
export const nodePalette: NodePaletteItem[] = [
  ...
  { type: "tools/colors/quantize-levels", category: "colors", glyph: "QLV", shortLabel: "QLevels", tooltip: "QUANTIZE LEVELS: divide in N livelli (2-64) e produce N mask binarie 0/255 come uscite immagine distinte." },
  ...
  { type: "tools/graphic/potrace", category: "graphic", glyph: "PTR", shortLabel: "Potrace", tooltip: "GRAPHIC POTRACE: vettorializzazione bitmap basata su Potrace JS (kilobtye), con output raster+SVG." },
