...
export const nodePalette: NodePaletteItem[] = [
  ...
  { type: "tools/crosshatch-bn", glyph: "XHB", shortLabel: "XH BN", tooltip: "CROSSHATCH BN: line art b/n multi-angolo (0-90) con output raster + SVG." },
  { type: "tools/matita", glyph: "MAT", shortLabel: "Matita", tooltip: "MATITA: single-line painter ottimizzato con passate, semplificazione RDP e output raster + SVG." },
